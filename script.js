...
document.addEventListener('DOMContentLoaded', function () {
  ...
  downloadCVBtn.addEventListener('click', function () {
    ...
    const cvContent = `
            Name: Mitali Kumari
            Email: mitalibscc3503@gmail.com
            Phone: +91 8603100733
            Location: India
            ...
            Portfolio: https://mitalikumariportfolio.com
            GitHub: https://github.com/Mitalikumaribth
            ...
            Contact: 8603100733
            LinkedIn: linkedin.com/in/mitalikumari
  ...
  hireMeBtn.addEventListener('click', function () {
    alert('Thank you for your interest! Please contact me at mitalibscc@gmail.com for hiring inquiries.');
  });

  contactMeBtn.addEventListener('click', function () {
    alert('Contact me at:\nEmail: mitalibscc3503@gmail.com\nPhone: +91 8603100733\nLinkedIn: https://www.linkedin.com/in/mitali-kumari-6a0685293?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app\nhttps://github.com/Mitalikumaribth \nTwitter: https://x.com/mitalikumaribth?t=rfgDhBDnaD5E0GC0-GH98Q&s=09\n');
  });
  ...
  socialLinks.forEach((link, index) => {
    ...
    link.addEventListener('click', function (e) {
      ...
      if (platform.includes('facebook')) {
        ...
        url = 'https://x.com/mitalikumaribth?t=rfgDhBDnaD5E0GC0-GH98Q&s=09';
      } else if (platform.includes('instagram')) {
        url = '#';
      } else if (platform.includes('linkedin')) {
        url = 'https://www.linkedin.com/in/mitali-kumari-6a0685293?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app';
      } else if (platform.includes('github')) {
        url = 'https://github.com/Mitalikumaribth';
      }
